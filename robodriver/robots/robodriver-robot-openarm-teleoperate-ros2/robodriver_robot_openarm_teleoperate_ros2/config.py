...
class GALAXEALITEAIORos2RobotConfig(RobotConfig):
    ...
    controller: Dict[str, Motor] = field(
    ...
    follower_motors: Dict[str, Motor] = field(
        default_factory=lambda norm_mode_body=norm_mode_body: {
            ...
            "left_gripper_degree_mm": Motor(8, "sts3215", MotorNormMode.RANGE_0_100),
            "right_arm_joint_1_rad": Motor(9, "sts3215", norm_mode_body),
            "right_arm_joint_2_rad": Motor(10, "sts3215", norm_mode_body),
            "right_arm_joint_3_rad": Motor(11, "sts3215", norm_mode_body),
            "right_arm_joint_4_rad": Motor(12, "sts3215", norm_mode_body),
            "right_arm_joint_5_rad": Motor(13, "sts3215", norm_mode_body),
            "right_arm_joint_6_rad": Motor(14, "sts3215", norm_mode_body),
            "right_arm_joint_7_rad": Motor(15, "sts3215", norm_mode_body),
            "right_gripper_degree_mm": Motor(16, "sts3215", MotorNormMode.RANGE_0_100),
        }
        }
    )
